...
const FundCard = ({ owner, title, description, target, deadline,
    ...
    return (
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer'
            onClick={handleClick}>
            <img src={image} alt={title} className="w-full h-[150px] object-cover rounded-[15px]" />
            <div className='flex flex-col p-4'>
                <div className='flex flex-row items-center mb-[18px]'>
                    <img src={tagType} alt="tag type"
                ...
                <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                    <div className='flex flex-col'>
                        ...
                        <p className='mt-[3px] font-epilogue font-normal text-[12px] leading-[15px] text-[#808191] sm:max-w-[120px] truncate'>
                            Raised of {target}
                        </p>
                    </div>
                    <div className='flex flex-col'>
